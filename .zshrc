...
### History ###
export HISTFILE=~/.zsh_history # file of history
export HISTSIZE=1000						# the number of history saving in memory
export HISTSIZE=10000					# the number of history saving in file
setopt share_history		# share history other shells
setopt hist_reduce_blanks # excessive space deleted when save.
setopt hist_save_no_dups #重複するコトンドが保存される時、古い方を削除する
